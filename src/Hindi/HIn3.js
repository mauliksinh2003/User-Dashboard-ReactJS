    ...
    return (
        <div style={{ backgroundColor: `${theme}` }}>
            ...
            <div style={{ textAlign: "left", marginBottom: "20px" , margin : "10px" , color: theme == "black" ? "white" : "black"       }}>
                <h3>रंग थीम बदलें</h3>
                <button onClick={() => changetheme("black")}>अँधेरा</button>
                <button onClick={() => changetheme("white")}>रोशनी</button>
                <button onClick={() => changetheme("gray")}>स्लेटी</button>
            </div>
        </div>
    )
}